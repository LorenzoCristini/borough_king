                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: AssetImage('assets/images/Subiaco/${cards[index]}.jpg'),
                                      fit: BoxFit.fill),
                                ),
                              )),
                          Padding(
...
class preferitiSubiaco extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Attività preferite a Subiaco", style: TextStyle(color: Colors.black)),
