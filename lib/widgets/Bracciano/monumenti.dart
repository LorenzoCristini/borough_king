...
class MonumentiBr extends StatelessWidget {
                ...
                child: Column(children: <Widget>[
                  Padding(
                      ...
                      child: Center(child: Text(
                        "Lago di Bracciano", style: TextStyle(fontSize: 21,fontFamily: "Times New Roman"),))
                  ),
                  Padding(
                      padding: EdgeInsets.all(10.0),
              ...
              child: Column(
                  children: <Widget>[
                    Align(alignment: Alignment.topLeft,
                        child: Row(children: <Widget>[
                          Text("Lago di Bracciano", style: TextStyle(fontSize: 25),),
                    ...
                    SizedBox(height: 10,),
                    Align(alignment: Alignment.topLeft,
                        child: Text("Il lago di Bracciano è un lago che riempie una depressione di origine vulcanica e tettonica.",
