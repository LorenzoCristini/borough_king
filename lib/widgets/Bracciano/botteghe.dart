              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage('assets/images/Bracciano/bott1.jpg'),
                      fit: BoxFit.fill),
                ...
                child: Column(children: <Widget>[
                  Padding(
                      ...
                      child: Center(child: Text(
                        "Alimenari Antonelli", style: TextStyle(fontSize: 21,fontFamily: "Times New Roman"),))
                  ),
                  Padding(
                      padding: EdgeInsets.all(10.0),
              ...
              child: Column(
                  children: <Widget>[
                    Align(alignment: Alignment.topLeft,
                        child: Row(children: <Widget>[
                          Text("Antonelli Alimentari", style: TextStyle(fontSize: 25),),
                    ...
                    Row(children: <Widget>[
                      Padding(padding: EdgeInsets.only(right: 10),
                          child: Icon(Icons.room)),
                      Center(child: Text("Via Principe di Napoli, 114\n Bracciano RM",
