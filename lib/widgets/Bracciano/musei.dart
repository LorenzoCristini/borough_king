          ...
          Padding(
            ...
            child: Column(
                children: <Widget>[
                  ...
                  Align(alignment: Alignment.topLeft,
                      child: Text(
                        "Il Museo Civico di Bracciano ha sede all’interno dell’ex convento di Santa Maria Novella",
          ...
          Padding(
            ...
            child: Column(
                children: <Widget>[
                  ...
                  Align(alignment: Alignment.topLeft,
                      child: Text(
                        "​​​Il Museo Storico ha sede nell’Idroscalo di Vigna di Valle, il più antico in Italia.",
                        style: TextStyle(fontSize: 18),)),
                  SizedBox(height: 10,),
                  Align(alignment: Alignment.topLeft,
                      child: Text("Orario", style: TextStyle(fontSize: 18),)),
