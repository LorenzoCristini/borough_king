...
class BottegheTo extends StatelessWidget {
  ...
  Widget InnerWidget(GlobalKey<SimpleFoldingCellState> key) {
    if (key == _foldingCellKey1){ return Container(
        color: Color(0xFFecf2f9),
            ...
            child: Column(
                children: <Widget>[
                  Align(alignment: Alignment.topLeft,
                      child: Row(children: <Widget>[
                        Text("Lamberto e Valeria", style: TextStyle(fontSize: 25),),
                  ...
                  SizedBox(height: 10,),
                  Align(alignment: Alignment.topLeft,
                      child: Text("La Tolfetana riporta dal passato le antiche tradizioni artigianali di Tolfa ,realizzata a mano con pelle conciata al vegetale.",
