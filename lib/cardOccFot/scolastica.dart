    ...
    return Scaffold(
      ...
      ListView(
        children: <Widget>[
          ...
          Row(
            children: [
              Padding(padding: EdgeInsets.only(right:100
                ...
                child: Text('Monastero di\nSanta Scolastica',style: TextStyle(fontSize: 30),
                ), ),
          ...
          Text("Il monastero di Santa Scolastica è uno dei luoghi più suggestivi del Lazio." ,style: TextStyle(fontSize: 20),),
          SizedBox(
            height: 10,
          ),
          Text("Orari:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
          Text("Tutti i giorni dalle 9.30 alle 12.15 e dalle 15.30 alle 18.15",style: TextStyle(fontSize: 18)),
          SizedBox(
            height: 10,
          ),
          ...
          Text("Arrivo: Monastero di Santa Scolastica",style: TextStyle(fontSize: 18)),
          SizedBox(
            height: 20,
          ),
          Image(
            image: AssetImage('assets/images/OccFotograf/comearrivaresubiaco.JPG'),
          ),
        ],
      ),
