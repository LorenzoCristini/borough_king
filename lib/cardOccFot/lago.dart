      ...
      ListView(
        children: <Widget>[
          ...
          Row(
            children: [
              Padding(padding: EdgeInsets.only(right:150
                ...
                child: Text('Lago',style: TextStyle(fontSize: 30),
                ), ),
          ...
          Padding(
            ...
            child: Text("Bracciano",style: TextStyle(fontSize: 22, fontFamily: "Times New Roman")),
          ),
          Text("La veduta dal lago di Bracciano è uno dei panorami più meravigliosi del mondo!" ,style: TextStyle(fontSize: 20),),
          SizedBox(
            height: 10,
          ),
          ...
          Text("Partenza: stazione di Bracciano",style: TextStyle(fontSize: 18)),
          Text("Arrivo: Lago",style: TextStyle(fontSize: 18)),
          SizedBox(
            height: 20,
          ),
          Image(
            image: AssetImage('assets/images/OccFotograf/comearrivarebracc.JPG'),
          ),
        ],
      ),
